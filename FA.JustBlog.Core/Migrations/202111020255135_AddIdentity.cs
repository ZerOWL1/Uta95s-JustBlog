namespace FA.JustBlog.Core.Migrations
{
    ...
    public partial class AddIdentity : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Comments", "Name", c => c.String(nullable: false, maxLength: 400, unicode: false));
            ...
            AlterColumn("dbo.Comments", "CommentTime", c => c.DateTime(nullable: false, precision: 7, storeType: "datetime2"));
        }
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Comments", "CommentHeader", c => c.String());
